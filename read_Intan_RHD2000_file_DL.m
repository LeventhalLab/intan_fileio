...
% >> clc
% >> read_Intan_RHD2000_file
%       select 'info.rhd' file from path
%
% revised by Daniel Leventhal, 12-06-2019 to accept a filename as an input
% and spit out an intan_data structure as output
%
% INPUT: 
%   filename - name of the .rhd file to read; the 'info.rhd' file is a
%   standard Intan file that contains records of sample_rate,
%   amplifier_bandwidth, channel names, etc. 
%
% OUTPUTS
%   intan_data structure with the following fields (however, check values for each prior to using for other functions):
%       intan_data.filename - 'info.rhd'
%       intan_data.path - e.g. 'Z:\Neuro-Leventhal\data\ChoiceTask\R0326\R0326-rawdata\R0326_20200228a\R0326_20200228_Testing_Level_200228_093554\'
%       intan_data.frequency_parameters
%           amplifier_sample_rate - 20000 Hz
%           aux_input_sample_rate - 5000 Hz
%           supply_voltage_sample_rate - 333.3333 Hz
%           board_adc_sample_rate - 20000 Hz
%           board_dig_in_sample_rate - 20000 Hz
%           desired_dsp_cutoff_frequency - 1
%           actual_dsp_cutoff_frequency - 0.7772
%           dsp_enabled - 1
%           desired_lower_bandwidth - 0.1
%           actual_lower_bandwidth - 0.0945
%           desired_upper_bandwidth - 7500
%           actual_upper_bandwidth - 7.603e+03
%           notch_filter_frequency - 0
%           desired_impedance_test_frequency - 1000
%           actual_impedance_test_frequency - 1000
%       intan_data.amplifier_channels - 64
%       intan_data.spike_triggers
%       intan_data.aux_input_channels - 3
%       intan_data.supply_voltage_channels
%       intan_data.board_adc_channels - 8
%       intan_data.board_dig_in_channels - 16
%       intan_data.board_dig_out_channels - 16
...
if (data_present)
    fprintf(1, 'Extracted data are now available in the intan_data structure.\n');
else
    fprintf(1, 'Extracted waveform information is now available in the intan_data structure.\n');
end
